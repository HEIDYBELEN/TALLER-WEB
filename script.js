...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const studentData = {
        name: 'Heidy Belen Abanto Paredes',
        code: 'U23215700',
        career: 'Ingeniería de Sistemas e Informatica',
        location: 'Chimbote, Perú',
        links: {
            github: 'https://github.com/HEIDYBELEN',
            linkedin: 'https://www.linkedin.com/in/heidy-abanto-23a439273/',
            email: 'mailto:u23215700@utp.edu.pe',
            cv: 'documents/cv.pdf',
            instagram: 'https://instagram.com/heibel06'
        }
    };
